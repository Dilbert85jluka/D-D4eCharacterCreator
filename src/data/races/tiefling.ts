...
export const tiefling: RaceData = {
  ...
  traits: [
    {
      name: 'Bloodhunt',
      description: 'You gain a +1 racial bonus to attack rolls against bloodied creatures.',
    },
    {
    ...
    {
      name: 'Infernal Wrath',
      description: 'You can use infernal wrath as an encounter power. Trigger: An enemy hits you. Effect (free action): The triggering enemy takes 1d6 + Intelligence or Charisma modifier fire damage.',
    },
  ],
