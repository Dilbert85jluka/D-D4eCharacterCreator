...
const OFFICIAL_FEATS: FeatData[] = [
  ...
  // ────────────────────────────────────────────────────────────
  // HotF (HEROES OF THE FEYWILD) — 32 feats
  // ────────────────────────────────────────────────────────────

  // ── Heroic Tier (28) ──────────────────────────────────────
  {
    id: 'hotf-arcane-familiar',
    name: 'Arcane Familiar',
    tier: 'Heroic',
    prerequisites: { class: ['wizard', 'warlock', 'sorcerer', 'bard'] },
    ...
    special: 'Any arcane class',
  },
  {
    id: 'hotf-arcane-porter',
    name: 'Arcane Porter',
    tier: 'Heroic',
    prerequisites: {},
    ...
    special: 'Arcane Familiar feat',
  },
  {
    id: 'hotf-battle-berserker',
  ...
  },
  {
    ...
    name: 'Beastwalker Circle',
    tier: 'Heroic',
    prerequisites: { class: ['druid'] },
    benefit: `You gain the wild shape power. Additionally, you can take a druid daily attack power at any level where you would normally gain an additional use of the summon natural ally power.`,
    special: 'Druid, summon natural ally power',
  },
  {
    id: 'hotf-berserk-vitality',
    name: 'Berserk Vitality',
    tier: 'Heroic',
    prerequisites: { class: ['barbarian'] },
    benefit: `When you enter your Berserker Fury, you gain temporary hit points equal to your healing surge value.`,
    special: 'Barbarian, Berserker Fury class feature',
  },
  {
    id: 'hotf-call-to-the-wild',
    name: 'Call to the Wild',
    tier: 'Heroic',
    prerequisites: { class: ['druid'] },
    benefit: `Choose one of your druid daily attack powers that has a level. You lose that power and gain the summon natural ally power, which you can use to summon a creature associated with your Primal Aspect and that has a level equal to or lower than the daily attack power you lost.`,
    special: 'Druid',
  },
  {
    id: 'hotf-fading-sneak',
    name: 'Fading Sneak',
    tier: 'Heroic',
    prerequisites: { race: ['gnome'], trainedSkill: ['stealth'] },
    benefit: `If your fade away is not expended, you can reroll a Stealth check and use either result. Doing so expends fade away.`,
    special: 'Gnome, fade away racial power, trained in Stealth',
  },
  {
    id: 'hotf-fading-target',
    name: 'Fading Target',
    tier: 'Heroic',
    prerequisites: { race: ['gnome'] },
    benefit: `As an immediate reaction, you can use fade away when an enemy misses you with a melee attack.`,
    special: 'Gnome, fade away racial power',
  },
  {
    id: 'hotf-familiars-vitality',
    name: "Familiar's Vitality",
    tier: 'Heroic',
    prerequisites: {},
  ...
  },
  {
    ...
    special: 'Fey origin or Fey Bond feat',
  },
  {
    id: 'hotf-fey-duelist',
    name: 'Fey Duelist',
    tier: 'Heroic',
    prerequisites: { race: ['eladrin'] },
    benefit: `If your fey step is not expended, you can gain combat advantage until the end of your next turn against each enemy that is adjacent to you. Doing so expends fey step.`,
    special: 'Eladrin, fey step racial power',
  },
  {
    id: 'hotf-fey-thievery',
    name: 'Fey Thievery',
    tier: 'Heroic',
    prerequisites: { race: ['eladrin'], trainedSkill: ['thievery'] },
    benefit: `While your fey step is not expended, you can make a Thievery check at a range of 5 squares. If you do so, you take a -2 penalty to the check.`,
    special: 'Eladrin, fey step racial power, trained in Thievery',
  },
  {
    id: 'hotf-ghost-feint',
    name: 'Ghost Feint',
    tier: 'Heroic',
    prerequisites: { race: ['gnome'], trainedSkill: ['bluff'] },
    benefit: `When you use ghost sound, you gain a +5 power bonus to your next Bluff check before the end of your next turn.`,
    special: 'Gnome, ghost sound power, trained in Bluff',
  },
  {
    id: 'hotf-guardian-towering-oak',
    name: 'Guardian of the Towering Oak',
    tier: 'Heroic',
    prerequisites: { race: ['hamadryad'] },
    benefit: `If your hamadryad aspects is not expended, you can reroll a Diplomacy check or an Intimidate check and use either result. Doing so expends hamadryad aspects.`,
    special: 'Hamadryad, hamadryad aspects racial power',
  },
  {
    id: 'hotf-harbinger-natures-wrath',
    name: "Harbinger of Nature's Wrath",
    tier: 'Heroic',
    prerequisites: { abilities: { wis: 13 } },
  ...
  },
  {
    ...
    tier: 'Heroic',
    prerequisites: { race: ['elf'] },
    benefit: `Immediately after you use elven accuracy, you can teleport up to 2 squares as a free action. In addition, you gain a +2 feat bonus to Arcana checks.`,
    special: 'Elf, elven accuracy racial power',
    bonuses: { skills: { arcana: 2 } },
  },
  {
    id: 'hotf-honeyed-words',
    name: 'Honeyed Words',
    tier: 'Heroic',
    prerequisites: { race: ['satyr'] },
    benefit: `If your lure of enchantment is not expended, you can reroll a Bluff check or a Diplomacy check and use either result. Doing so expends lure of enchantment.`,
    special: 'Satyr, lure of enchantment racial power',
  },
  {
    id: 'hotf-master-of-stories',
    name: 'Master of Stories',
    tier: 'Heroic',
    prerequisites: { abilities: { cha: 13 } },
  ...
  },
  {
    ...
    tier: 'Heroic',
    prerequisites: { race: ['wilden'] },
    benefit: `If the racial power granted by your Nature's Aspect is not expended, you can lose one use of the power as a minor action to create difficult terrain for your enemies in a burst 1 within 5 squares of you. The difficult terrain lasts until the end of your next turn.`,
    special: "Wilden, Nature's Aspect racial trait",
  },
  {
    id: 'hotf-plants-sap',
    ...
    tier: 'Heroic',
    prerequisites: { race: ['wilden'] },
    benefit: `You do not need to eat. You also do not need to sleep and instead enter a state of inactivity for 4 hours to gain the benefits of an extended rest. While in this state, you are fully aware of your surroundings and notice approaching enemies and other events as normal. In addition, you gain a +2 feat bonus to saving throws against ongoing damage.`,
    special: 'Wilden',
  },
  {
    id: 'hotf-skald-training',
    name: 'Skald Training',
    tier: 'Heroic',
    prerequisites: { class: ['bard'] },
    benefit: `You swap your majestic word for the skald's aura power. You and your allies can use minor actions to benefit from the aura only as many times during an encounter as you would be able to use majestic word.`,
    special: 'Bard, majestic word power',
  },
  {
    id: 'hotf-streak-of-light',
    name: 'Streak of Light',
    tier: 'Heroic',
    prerequisites: { race: ['pixie'] },
    benefit: `When you make a charge attack, you gain combat advantage for that attack.`,
    special: 'Pixie',
  },
  {
    id: 'hotf-teeny-target',
    name: 'Teeny Target',
    tier: 'Heroic',
    prerequisites: { race: ['pixie'] },
  ...
  {
    id: 'hotf-totem-expertise',
    name: 'Totem Expertise',
    tier: 'Heroic',
    prerequisites: {},
    benefit: `You gain a +1 feat bonus to implement attack rolls you make with a totem. This bonus increases to +2 at 11th level and +3 at 21st level. Also, you ignore partial cover and partial concealment on implement attacks you make with a totem.`,
  },
  {
    id: 'hotf-two-handed-weapon-expertise',
    name: 'Two-Handed Weapon Expertise',
    tier: 'Heroic',
    prerequisites: {},
  ...
  },
  {
    ...
    tier: 'Heroic',
    prerequisites: { race: ['wilden'] },
    benefit: `You gain a +2 feat bonus to Acrobatics checks. In addition, when you use your Nature's Aspect racial power, your melee reach increases by 1 until the end of your next turn.`,
    special: "Wilden, Nature's Aspect racial trait",
    bonuses: { skills: { acrobatics: 2 } },
  },
  {
    id: 'hotf-walk-among-men',
    name: 'Walk among Men',
    tier: 'Heroic',
    prerequisites: { race: ['satyr'] },
    benefit: `During a short rest, you can change your appearance to that of a male human, eladrin, or elf. Your face and build remain recognizably yours, but you otherwise appear to be a member of the chosen race. This illusion lasts until you end it as a minor action or until you die.`,
    special: 'Satyr',
  },
  {
    id: 'hotf-witchcraft-initiate',
    name: 'Witchcraft Initiate',
    tier: 'Heroic',
    prerequisites: { abilities: { int: 13 } },
  ...
  // ── Paragon Tier (3) ──────────────────────────────────────
  {
    id: 'hotf-flitting-harrier',
    name: 'Flitting Harrier',
    tier: 'Paragon',
    prerequisites: { minLevel: 11, race: ['pixie'] },
    benefit: `When you enter or leave an enemy's space, you do not provoke an opportunity attack from that enemy.`,
    special: '11th level, pixie',
  },
  {
    id: 'hotf-guardian-weeping-willow',
    name: 'Guardian of the Weeping Willow',
    tier: 'Paragon',
    prerequisites: { minLevel: 11, race: ['hamadryad'] },
    ...
    special: '11th level, hamadryad, hamadryad aspects racial power',
  },
  {
    id: 'hotf-powerful-lure',
    name: 'Powerful Lure',
    tier: 'Paragon',
    prerequisites: { minLevel: 11, race: ['satyr'] },
    benefit: `When you use lure of enchantment, you can slide the target up to 6 squares, instead of the normal distance, and you can slide it into hindering terrain.`,
    special: '11th level, satyr, lure of enchantment racial power',
  },
  ...
  // ── Epic Tier (1) ─────────────────────────────────────────
  {
    ...
    special: '21st level, fey origin or Fey Bond feat',
  },
];
