...
export const barbarianPowers: PowerData[] = [
  ...
  },
  {
    ...
    attack: 'Strength vs. Fortitude',
    hit: '3[W] + Strength modifier damage. Make a secondary attack that is a close burst 1. Secondary',
  },
  {
  ...
  },
  {
    ...
    target: 'One creature Primary',
    attack: 'Strength vs. Fortitude',
    hit: '2[W] + Strength modifier damage, and you push the target 1 square. You then shift 1 square and make a secondary attack. Secondary',
  ...
  },
  {
    ...
    effect: 'You move your speed and then make a secondary attack. Secondary',
  },
