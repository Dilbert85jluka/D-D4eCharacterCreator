...
export const ardentPowers: PowerData[] = [
  ...
  },
  {
    ...
    effect: 'Before the end of the encounter, you can make the following secondary attack once, either when the primary target drops to 0 hit points or as a minor action. The secondary attack is a close burst 2 centered on the primary target. Secondary Target: Each enemy in the burst. Secondary Attack: Charisma vs. Will. Hit: 2d10 + Charisma modifier psychic damage, and the secondary target is dazed until the end of your next turn.',
  },
  {
